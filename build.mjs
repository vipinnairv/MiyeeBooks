...
async function buildOnce() {
  ...
  // PWA assets: manifest, service worker and icons (installable + offline).
  for (const asset of ['manifest.webmanifest', 'sw.js', 'icon.svg', 'icon-maskable.svg']) {
    if (existsSync(join(srcDir, asset))) copyFileSync(join(srcDir, asset), join(distDir, asset));
  }
